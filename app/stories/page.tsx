...
// Revalidate the page on every request (server-side rendering)
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5">
                {stories.map((story) => (
                    <Link 
                        ...
                        className='border rounded-lg cursor-pointer hover:border-purple-500 transition-all duration-300 ease-in-out hover:shadow-2xl'
                    >
