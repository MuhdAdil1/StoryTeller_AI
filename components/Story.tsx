                        ...
                        {story.pages.map((page,i) => (
                            <CarouselItem key={i}>
                                <Card className="p-5 md:p-10 border">
                                    <h2 className="text-center text-gray-500 text-2xl">{story.story}</h2>
                                    <CardContent className="p-5 xl:flex">
                                        <Image
                                            ...
                                            width={500}
                                            height={500}
                                            className="w-80 h-80 xl:w-[500px] xl:h-[500px]
                                            rounded-3xl mx-auto float-right p-5 xl:order-last"
